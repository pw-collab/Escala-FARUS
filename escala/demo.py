...
VOLUNTARIOS_DEMO: list[tuple[str, str, bool, list[str]]] = [
    ...
    ("Isabela Moraes", "(11) 91234-0009", True, ["Infantil 6-9", "Infantil 10-12"]),
    ...
    ("Mariana Alves", "(11) 91234-0013", True, ["Infantil 2-5", "Adolescentes 13-17"]),
    ...
    ("Sabrina Pires", "(11) 91234-0019", True, ["Infantil 2-5", "Infantil 10-12"]),
    ("Thiago Mendes", "(11) 91234-0020", True, ["Louvor", "Staff"]),
    ("Úrsula Campos", "(11) 91234-0021", True, ["Recepção", "Maná Coffee"]),
    ("Vinícius Braga", "(11) 91234-0022", True, ["Oferta", "Projetor", "Adolescentes 13-17"]),
    ...
    ("Beatriz Fonseca", "(11) 91234-0026", True, ["Maná Coffee", "Infantil 10-12", "Servo da Ceia"]),
    ("Caio Vasconcelos", "(11) 91234-0027", True, ["Captação", "Abertura"]),
    ("Débora Antunes", "(11) 91234-0028", True, ["Louvor", "Intercessão", "Adolescentes 13-17"]),
...
FUNCOES_DEMO: list[tuple[str, str, int, int, bool, bool]] = [
    ...
    ("Infantil 10-12", "Domingo", 1, 1, False, True),
    ("Adolescentes 13-17", "Domingo", 1, 1, False, True),
